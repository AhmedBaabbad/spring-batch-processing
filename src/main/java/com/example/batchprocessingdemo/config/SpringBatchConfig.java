...
import com.example.batchprocessingdemo.repository.CustomerRespository;
...
public class SpringBatchConfig {
    ...
    public RepositoryItemWriter<Customer> writer ()
    {
        ...
        repositoryItemWriter.setRepository(customerRespository);
